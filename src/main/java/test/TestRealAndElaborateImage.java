...
public class TestRealAndElaborateImage {
	...
	public static void main(String[] args) {
		...
		ses.subscribe((sessionResponse) -> {
			...
			if (sessionResponse.success) {
				...
				Observable<byte[]> img = sampleApi.getRealTimeImage("micro2", sessionResponse.data.user.code, true)
				...
				img.subscribe((image) -> {
					...
					if (image != null) {
						...
						try {
							fos = new FileOutputStream("images/real.png");
							fos.write(image);
						} catch (IOException e) {
